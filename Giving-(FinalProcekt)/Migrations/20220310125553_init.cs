        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CauseNeed = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    IframeLink = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HappyFaces", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IframeLink = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonaterTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DonaterCount = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    VoluteerTitle = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    VoluteerCount = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CauseGalleries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CauseGalleries_Causes_CauseId",
                        column: x => x.CauseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonatePrices", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonatePrices_Donates_DonateId",
                        column: x => x.DonateId,
                        principalTable: "Donates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonatePrices_Prices_PriceId",
                        column: x => x.PriceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagToEvents_TagEvents_TagEventId",
                        column: x => x.TagEventId,
                        principalTable: "TagEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CauseGalleries_CauseId",
                table: "CauseGalleries",
                column: "CauseId");

            migrationBuilder.CreateIndex(
                name: "IX_Comments_CauseId",
                table: "Comments",
                column: "CauseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonatePrices_DonateId",
                table: "DonatePrices",
                column: "DonateId");

            migrationBuilder.CreateIndex(
                name: "IX_DonatePrices_PriceId",
                table: "DonatePrices",
                column: "PriceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagToEvents_TagEventId",
                table: "TagToEvents",
                column: "TagEventId");
        }
